...
# Gemini Lossless Watermark Remover - [gwr.shshensi.cn](https://gwr.shshensi.cn)
...
<p align="center">
  <img src="https://count.getloli.com/@gemini-watermark-remover-cn?name=gemini-watermark-remover-cn&theme=minecraft&padding=7&offset=0&align=top&scale=1&pixelated=1&darkmode=auto" width="400">
</p>
...
> [!NOTE]
> **Note**: Disabling any fingerprint defender extensions (e.g., Canvas Fingerprint Defender) to avoid processing errors. https://github.com/misterye/gemini-watermark-remover-cn/issues/3

## Usage

### Online Website

1. Open [gwr.shshensi.cn](https://gwr.shshensi.cn).
...
2. Open [gemini-watermark-remover-cn.user.js](https://gwr.shshensi.cn/userscript/gemini-watermark-remover-cn.user.js).
